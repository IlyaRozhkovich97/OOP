...
print("\n\033[91mПроверка исключения ValueError:\033[0m")

category1 = Category("Электроника", "Товары электроники и бытовой техники")

# Попытка добавления продукта с нулевым количеством
try:
    category1.add_product(Product("Ноутбук", "Мощный ноутбук для работы и игр", 1500, 0))
except ValueError as e:
    print("Ошибка:", e)

# Попытка добавления продукта с ненулевым количеством
try:
    category1.add_product(Product("Смартфон", "Смартфон с высоким разрешением камеры", 800, 20))
except ValueError as e:
    print("Ошибка:", e)

# Вывод списка продуктов в категории
print("Продукты в категории:", category1.get_products_format)
...
print("\n\033[91mПодсчет среднего ценника всех товаров в категории (рабочий метод):\033[0m")

# Создание категории
category1 = Category("Электроника", "Товары электроники и бытовой техники")

# Добавление нескольких продуктов в категорию
category1.add_product(Product("Ноутбук", "Мощный ноутбук для работы и игр", 1500, 10))
category1.add_product(Product("Смартфон", "Смартфон с высоким разрешением камеры", 800, 20))
category1.add_product(Product("Наушники", "Беспроводные наушники с хорошим звуком", 200, 30))

# Вывод средней цены товаров в категории
print("Средняя цена товаров в категории:", round(category1.average_price(), 2))

print("\n\033[91mПодсчет среднего ценника всех товаров в категории (нерабочий метод):\033[0m")
# Создание категории
category1 = Category("Электроника", "Товары электроники и бытовой техники")

# Вывод средней цены товаров в категории
print("Средняя цена товаров в категории:", category1.average_price())
